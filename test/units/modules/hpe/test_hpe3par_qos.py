...
#Create
    ...
    def test_create_qos_rule_create_exception_in_login(self, mock_client):
        ...
        result = qos.create_qos_rule(mock_client.HPE3ParClient,"user","password",'qos_tgt_name',None,None,None,None,None,None,None,None,None,None,None,None,None,None)
    ...
    def test_create_qos_rule_create_sucess_login(self, mock_client):
        ...
        mock_client.HPE3ParClient.return_value = mock_client
        result = qos.create_qos_rule(mock_client.HPE3ParClient,"user","password",'qos_tgt_name','vvset',None,None,None,None,None,None,None,None,None,None,None,None,None)
    ...
    def test_create_qos_rule_create_sucess_login_latency_goal_latency_goal_usecs(self, mock_client):
        ...
        mock_client.HPE3ParClient.qosRuleExists.return_value = False
        mock_client.HPE3ParClient.return_value = mock_client
        result = qos.create_qos_rule(mock_client.HPE3ParClient,"user","password",'qos_tgt_name',None,None,None,None,None,None,None,None,None,None,20,None,None,10)
...
#Modify
    ...
    def test_modify_qos_rule_create_exception_in_login(self, mock_client):
        ...
        mock_client.HPE3ParClient.login.side_effect = Exception("Failed to login!")
        mock_client.HPE3ParClient.return_value = mock_client
        result = qos.modify_qos_rule(mock_client.HPE3ParClient,"user","password",'qos_tgt_name',None,None,None,None,None,None,None,None,None,None,None,None,None,None)
